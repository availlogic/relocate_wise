...
import { ApiError } from '@relocatewise/web-container/api';
...
vi.mock('@relocatewise/web-container/api', async () => {
  const actual = await vi.importActual<typeof import('@relocatewise/web-container/api')>('@relocatewise/web-container/api');
